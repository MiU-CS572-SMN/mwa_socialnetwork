...
exports.createPost  =  async (req, res) => {
  ...
  // save the post if all is okay
      ...
      */
  // use loadash's utility method pick and hash the password
  post = new Post(_.pick(req.body, ['postTime','owner','content', 'hasUnhealthy',
                                    'notifyFollowers', 'comments', 'likedBy',
                                    'unlikedBy','photo','isVisible']));
  await post.save();
